...
**Original repo:** https://github.com/kmaasrud/awesome-obsidian
**Stars:** ~7k ⭐
**Category:** Curated List / Reference
**Local path in vibe-coder:** new_repos/awesome-obsidian/
**License:** CC0-1.0
...
| QuickAdd | Trigger note creation via command/API |
| Shell commands | Run obsidian-update.sh from inside Obsidian |
...
Templater + QuickAdd = auto-trigger note creation from AI tasks.
