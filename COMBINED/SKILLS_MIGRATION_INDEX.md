...
| 2.4.2 Claude finance | `Skills/claude-skills/finance` | `COMBINED/skills/data-analysis/claude-skills-finance` | 1 | 0 | ✅ |
| 2.4.2 Claude growth | `Skills/claude-skills/business-growth` | `COMBINED/skills/business/claude-skills-growth` | 1 | 0 | ✅ |
| 2.4.2 Claude c-level | `Skills/claude-skills/c-level-advisor` | `COMBINED/skills/business/claude-skills-c-level` | 3 | 0 | ✅ |
| 2.4.2 Claude ra-qm | `Skills/claude-skills/ra-qm-team` | `COMBINED/skills/business/claude-skills-ra-qm` | 1 | 0 | ✅ |
...
| 2.4.4 Deer chart | `Orchestration/deer-flow/skills/public/chart-visualization` | `COMBINED/skills/data-analysis/deer-flow-chart` | 28 | 0 | ✅ |
| 2.4.4 Deer data-analysis | `Orchestration/deer-flow/skills/public/data-analysis` | `COMBINED/skills/data-analysis/deer-flow-data-analysis` | 2 | 0 | ✅ |
...
| 2.4.4 Deer podcast | `Orchestration/deer-flow/skills/public/podcast-generation` | `COMBINED/skills/writing/deer-flow-podcast` | 3 | 0 | ✅ |
| 2.4.4 Deer ppt | `Orchestration/deer-flow/skills/public/ppt-generation` | `COMBINED/skills/writing/deer-flow-ppt` | 2 | 0 | ✅ |
| 2.4.4 Deer devops | `Orchestration/deer-flow/skills/public/vercel-deploy-claimable` | `COMBINED/skills/devops/deer-flow-vercel-deploy` | 2 | 0 | ✅ |
...
| 2.4.5 Obsidian | `Skills/obsidian-skills` | `COMBINED/skills/platform/obsidian` | 13 | 0 | ✅ |
