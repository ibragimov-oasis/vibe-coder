...
python3 ~/COMBINED/workspace-config/claude/skills/design/scripts/icon/generate.py --prompt "notification bell" --batch 6 --style outlined --output-dir ./icons
```
...
```bash
python3 ~/COMBINED/workspace-config/claude/skills/design/scripts/icon/generate.py --list-styles
python3 ~/COMBINED/workspace-config/claude/skills/design/scripts/icon/generate.py --list-categories
```
