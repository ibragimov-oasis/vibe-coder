...
**Project skills:** Check `COMBINED/workspace-config/claude/skills/` or `.agents/skills/` directory if either exists. Research should account for project skill patterns.
</project_context>
