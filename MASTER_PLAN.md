новое обновление : 2 апреля 2026 10:40 утра. мы создали новую ветку и там мы будем не копировать а перемищать файлы из оригинальных репозиториев а не копировать. потому что при копировании мы заметили то что он не может потом понять что осталось leftovers. а так он может он проверит все и сверит с оригинальным файлом. теперь выполни все что сказано в master_plan.md. 
