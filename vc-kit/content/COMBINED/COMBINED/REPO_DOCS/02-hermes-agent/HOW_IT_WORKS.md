...
|-------------|-----------------------|-----|
| skills/media/youtube-content/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/simpo/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/creative/popular-web-designs/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/research/arxiv/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/research/scrapling/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/flash-attention/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/llava/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mcp/native-mcp/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/autonomous-ai-agents/codex/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/training/trl-fine-tuning/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/security/oss-forensics/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/research/research-paper-writing/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/nemo-curator/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/note-taking/obsidian/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/github/github-code-review/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/productivity/memento-flashcards/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/autonomous-ai-agents/hermes-agent/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/apple/apple-reminders/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/creative/blender-mcp/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/models/segment-anything/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/tensorrt-llm/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/slime/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/creative/ascii-video/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/apple/imessage/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/pytorch-lightning/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/torchtitan/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/migration/openclaw-migration/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/cloud/modal/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/chroma/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mcp/mcporter/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/health/neuroskill-bci/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/media/heartmula/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/software-development/plan/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/research/dspy/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/blockchain/base/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/lambda-labs/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/evaluation/lm-evaluation-harness/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/github/github-issues/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/huggingface-hub/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/productivity/canvas/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/research/polymarket/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/apple/apple-notes/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/leisure/find-nearby/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/pinecone/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/software-development/writing-plans/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/evaluation/weights-and-biases/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/inference/vllm/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/research/gitnexus-explorer/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/software-development/test-driven-development/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/research/bioinformatics/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/productivity/telephony/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/training/unsloth/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/research/blogwatcher/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/productivity/ocr-and-documents/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/inference/gguf/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/creative/meme-generation/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/models/whisper/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/email/himalaya/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/software-development/systematic-debugging/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/github/github-pr-workflow/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/qdrant/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/research/parallel-cli/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/productivity/notion/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/autonomous-ai-agents/opencode/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/autonomous-ai-agents/blackbox/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/inference/outlines/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/devops/webhook-subscriptions/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/communication/one-three-one-rule/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/red-teaming/godmode/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/productivity/siyuan/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/research/duckduckgo-search/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/instructor/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/gaming/minecraft-modpack-server/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/blockchain/solana/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/dogfood/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/security/sherlock/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/creative/ascii-art/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/inference/obliteratus/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/productivity/linear/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/media/gif-search/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/media/songsee/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/github/github-auth/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| AGENTS.md | .claude/agents/by-role/hermes-agent/ | Core agent files |
| skills/productivity/nano-pdf/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/software-development/subagent-driven-development/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/data-science/jupyter-live-kernel/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mcp/fastmcp/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/models/audiocraft/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/devops/docker-management/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/training/axolotl/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| README.md | .claude/REPO_DOCS/02-hermes-agent/ | Documentation |
| skills/github/codebase-inspection/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/apple/findmy/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/training/peft/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/saelens/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/software-development/requesting-code-review/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/training/grpo-rl-training/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/productivity/powerpoint/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/smart-home/openhue/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/models/clip/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/training/pytorch-fsdp/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/devops/cli/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/research/qmd/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/github/github-repo-management/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/creative/songwriting-and-ai-music/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/gaming/pokemon-player/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/inference/guidance/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/huggingface-tokenizers/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/social-media/xitter/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/productivity/google-workspace/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/accelerate/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/creative/excalidraw/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/hermes-atropos-environments/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/models/stable-diffusion/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/mlops/faiss/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/email/agentmail/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/mlops/inference/llama-cpp/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| skills/autonomous-ai-agents/claude-code/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/security/1password/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
| optional-skills/research/domain-intel/SKILL.md | .claude/skills/hermes-agent/ | Agent skill definition |
