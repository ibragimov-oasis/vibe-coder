...
!python3 ~/COMBINED/workspace-config/claude/skills/last30days/scripts/last30days.py "your topic" --emit=context
```
...
```bash
CONTEXT_PATH=$(python3 ~/COMBINED/workspace-config/claude/skills/last30days/scripts/last30days.py "topic" --emit=path)
cat "$CONTEXT_PATH"
```

### JSON for Programmatic Use
```bash
python3 ~/COMBINED/workspace-config/claude/skills/last30days/scripts/last30days.py "topic" --emit=json > research.json
```

## CLI Reference

```
python3 ~/COMBINED/workspace-config/claude/skills/last30days/scripts/last30days.py <topic> [options]
