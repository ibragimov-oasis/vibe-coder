...
| 工具            | 状态          | 路径                                                                  |
| :-------------- | :-------------- | :-------------------------------------------------------------------- |
| **Claude Code** | ✅ 完全支持 | `.claude/workspace-config/claude/skills/` 或通过 `/plugin marketplace add sickn33/antigravity-awesome-skills` 安装 |
...
如果您更喜欢使用 Claude Code 的插件市场流程而不是复制到 `.claude/workspace-config/claude/skills/`，请使用：
