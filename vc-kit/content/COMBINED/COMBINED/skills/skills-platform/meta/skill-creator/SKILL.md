...
**Repository only:** Files in `.github/skills/`, `.claude/workspace-config/claude/skills/`, or `.codex/skills/`

**Global installation:** Create symlinks:
```bash
ln -sf "$SKILLS_REPO/.github/skills/$SKILL_NAME" "$HOME/.copilot/skills/$SKILL_NAME"
ln -sf "$SKILLS_REPO/.claude/workspace-config/claude/skills/$SKILL_NAME" "$HOME/.claude/workspace-config/claude/skills/$SKILL_NAME"
```
