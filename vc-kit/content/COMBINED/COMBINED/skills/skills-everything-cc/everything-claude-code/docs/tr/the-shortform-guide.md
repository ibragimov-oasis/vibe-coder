...
- **Skill'ler**: `~/.claude/workspace-config/claude/skills/` - daha geniş iş akışı tanımları
- **Command'lar**: `~/.claude/workspace-config/claude/commands/` - hızlı çalıştırılabilir prompt'lar
