...
| Learned | `~/.claude/workspace-config/claude/skills/learned/` | No | Required |
| Imported | `~/.claude/workspace-config/claude/skills/imported/` | No | Required |
...
Location: `~/.claude/workspace-config/claude/skills/learned/<skill-name>/`.
...
Location: `~/.claude/workspace-config/claude/skills/imported/<skill-name>/`.
...
`scripts/skills-health.js`, `scripts/lib/skill-evolution/health.js`, session hooks: they probe `~/.claude/workspace-config/claude/skills/learned` and `~/.claude/workspace-config/claude/skills/imported`. Missing directories are treated as empty; no errors.

## Publishable vs Local-Only

| Publishable | Local-Only |
|-------------|------------|
| `skills/*` (curated) | `~/.claude/workspace-config/claude/skills/learned/*` |
| | `~/.claude/workspace-config/claude/skills/imported/*` |
