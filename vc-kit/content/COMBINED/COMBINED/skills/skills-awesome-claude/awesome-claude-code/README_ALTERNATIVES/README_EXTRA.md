...
<a href="https://github.com/omril321/automated-notebooklm/blob/main/.claude/workspace-config/claude/commands/create-hook.md"><img src="../assets/badge-create-hook.svg" alt="/create-hook"></a>  
...
<a href="https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/analyze-issue.md"><img src="../assets/badge-analyze-issue.svg" alt="/analyze-issue"></a>  
...
<a href="https://github.com/evmts/tevm-monorepo/blob/main/.claude/workspace-config/claude/commands/commit.md"><img src="../assets/badge-commit.svg" alt="/commit"></a>  
...
<a href="https://github.com/steadycursor/steadystart/blob/main/.claude/workspace-config/claude/commands/2-commit-fast.md"><img src="../assets/badge-commit-fast.svg" alt="/commit-fast"></a>  
...
<a href="https://github.com/toyamarinyon/giselle/blob/main/.claude/workspace-config/claude/commands/create-pr.md"><img src="../assets/badge-create-pr.svg" alt="/create-pr"></a>  
...
<a href="https://github.com/liam-hq/liam/blob/main/.claude/workspace-config/claude/commands/create-pull-request.md"><img src="../assets/badge-create-pull-request.svg" alt="/create-pull-request"></a>  
...
<a href="https://github.com/evmts/tevm-monorepo/blob/main/.claude/workspace-config/claude/commands/create-worktrees.md"><img src="../assets/badge-create-worktrees.svg" alt="/create-worktrees"></a>  
...
<a href="https://github.com/jeremymailen/kotlinter-gradle/blob/master/.claude/workspace-config/claude/commands/fix-github-issue.md"><img src="../assets/badge-fix-github-issue.svg" alt="/fix-github-issue"></a>  
...
<a href="https://github.com/metabase/metabase/blob/master/.claude/workspace-config/claude/commands/fix-issue.md"><img src="../assets/badge-fix-issue.svg" alt="/fix-issue"></a>  
...
<a href="https://github.com/metabase/metabase/blob/master/.claude/workspace-config/claude/commands/fix-pr.md"><img src="../assets/badge-fix-pr.svg" alt="/fix-pr"></a>  
...
<a href="https://github.com/evmts/tevm-monorepo/blob/main/.claude/workspace-config/claude/commands/husky.md"><img src="../assets/badge-husky.svg" alt="/husky"></a>  
...
<a href="https://github.com/giselles-ai/giselle/blob/main/.claude/workspace-config/claude/commands/update-branch-name.md"><img src="../assets/badge-update-branch-name.svg" alt="/update-branch-name"></a>  
...
<a href="https://github.com/rygwdn/slack-tools/blob/main/.claude/workspace-config/claude/commands/check.md"><img src="../assets/badge-check.svg" alt="/check"></a>  
...
<a href="https://github.com/kingler/n8n_agent/blob/main/.claude/workspace-config/claude/commands/code_analysis.md"><img src="../assets/badge-code-analysis.svg" alt="/code_analysis"></a>  
...
<a href="https://github.com/to4iki/ai-project-rules/blob/main/.claude/workspace-config/claude/commands/optimize.md"><img src="../assets/badge-optimize.svg" alt="/optimize"></a>  
...
<a href="https://github.com/rzykov/metabase/blob/master/.claude/workspace-config/claude/commands/repro-issue.md"><img src="../assets/badge-repro-issue.svg" alt="/repro-issue"></a>  
...
<a href="https://github.com/zscott/pane/blob/main/.claude/workspace-config/claude/commands/tdd.md"><img src="../assets/badge-tdd.svg" alt="/tdd"></a>  
...
<a href="https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/tdd-implement.md"><img src="../assets/badge-tdd-implement.svg" alt="/tdd-implement"></a>  
...
<a href="https://github.com/elizaOS/elizaos.github.io/blob/main/.claude/workspace-config/claude/commands/context-prime.md"><img src="../assets/badge-context-prime.svg" alt="/context-prime"></a>  
...
<a href="https://github.com/okuvshynov/cubestat/blob/main/.claude/workspace-config/claude/commands/initref.md"><img src="../assets/badge-initref.svg" alt="/initref"></a>  
...
<a href="https://github.com/ethpandaops/xatu-data/blob/master/.claude/workspace-config/claude/commands/load-llms-txt.md"><img src="../assets/badge-load-llms-txt.svg" alt="/load-llms-txt"></a>  
...
<a href="https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/load_coo_context.md"><img src="../assets/badge-load-coo-context.svg" alt="/load_coo_context"></a>  
...
<a href="https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/load_dango_pipeline.md"><img src="../assets/badge-load-dango-pipeline.svg" alt="/load_dango_pipeline"></a>  
...
<a href="https://github.com/yzyydev/AI-Engineering-Structure/blob/main/.claude/workspace-config/claude/commands/prime.md"><img src="../assets/badge-prime.svg" alt="/prime"></a>  
...
<a href="https://github.com/ddisisto/si/blob/main/.claude/workspace-config/claude/commands/rsi.md"><img src="../assets/badge-rsi.svg" alt="/rsi"></a>  
...
<a href="https://github.com/berrydev-ai/blockdoc-python/blob/main/.claude/workspace-config/claude/commands/add-to-changelog.md"><img src="../assets/badge-add-to-changelog.svg" alt="/add-to-changelog"></a>  
...
<a href="https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/create-docs.md"><img src="../assets/badge-create-docs.svg" alt="/create-docs"></a>  
...
<a href="https://github.com/slunsford/coffee-analytics/blob/main/.claude/workspace-config/claude/commands/docs.md"><img src="../assets/badge-docs.svg" alt="/docs"></a>  
...
<a href="https://github.com/hackdays-io/toban-contribution-viewer/blob/main/.claude/workspace-config/claude/commands/explain-issue-fix.md"><img src="../assets/badge-explain-issue-fix.svg" alt="/explain-issue-fix"></a>  
...
<a href="https://github.com/Consiliency/Flutter-Structurizr/blob/main/.claude/workspace-config/claude/commands/update-docs.md"><img src="../assets/badge-update-docs.svg" alt="/update-docs"></a>  
...
<a href="https://github.com/kelp/webdown/blob/main/.claude/workspace-config/claude/commands/release.md"><img src="../assets/badge-release.svg" alt="/release"></a>  
...
<a href="https://github.com/hackdays-io/toban-contribution-viewer/blob/main/.claude/workspace-config/claude/commands/run-ci.md"><img src="../assets/badge-run-ci.svg" alt="/run-ci"></a>  
...
<a href="https://github.com/scopecraft/command/blob/main/.claude/workspace-config/claude/commands/create-command.md"><img src="../assets/badge-create-command.svg" alt="/create-command"></a>  
...
<a href="https://github.com/hesreallyhim/inkverse-fork/blob/preserve-claude-resources/.claude/workspace-config/claude/commands/create-plan.md"><img src="../assets/badge-create-plan.svg" alt="/create-plan"></a>  
...
<a href="https://github.com/Wirasm/claudecode-utils/blob/main/.claude/workspace-config/claude/commands/create-prp.md"><img src="../assets/badge-create-prp.svg" alt="/create-prp"></a>  
...
<a href="https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/do-issue.md"><img src="../assets/badge-do-issue.svg" alt="/do-issue"></a>  
...
<a href="https://github.com/disler/just-prompt/blob/main/.claude/workspace-config/claude/commands/project_hello_w_name.md"><img src="../assets/badge-project-hello-w-name.svg" alt="/project_hello_w_name"></a>  
...
<a href="https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/fixing_go_in_graph.md"><img src="../assets/badge-fixing-go-in-graph.svg" alt="/fixing_go_in_graph"></a>  
...
<a href="https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/review_dcell_model.md"><img src="../assets/badge-review-dcell-model.svg" alt="/review_dcell_model"></a>  
...
<a href="https://github.com/zuplo/docs/blob/main/.claude/workspace-config/claude/commands/use-stepper.md"><img src="../assets/badge-use-stepper.svg" alt="/use-stepper"></a>  
