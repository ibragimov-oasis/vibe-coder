...
Impressive CLI toolkit providing auto-save checkpointing, code quality hooks, specification generation and execution, and 20+ specialized subagents including oracle (gpt-4o), code-reviewer (6-aspect deep analysis), ai-sdk-expert (Vercel AI SDK), typescript-expert and many more for Claude Code workflows.
...
[`/create-hook`](https://github.com/omril321/automated-notebooklm/blob/main/.claude/workspace-config/claude/commands/create-hook.md) &nbsp; by &nbsp; [Omri Lavi](https://github.com/omril321)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;Apache-2.0  
...
[`/analyze-issue`](https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/analyze-issue.md) &nbsp; by &nbsp; [jerseycheese](https://github.com/jerseycheese)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/commit`](https://github.com/evmts/tevm-monorepo/blob/main/.claude/workspace-config/claude/commands/commit.md) &nbsp; by &nbsp; [evmts](https://github.com/evmts)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/commit-fast`](https://github.com/steadycursor/steadystart/blob/main/.claude/workspace-config/claude/commands/2-commit-fast.md) &nbsp; by &nbsp; [steadycursor](https://github.com/steadycursor)    
...
[`/create-pr`](https://github.com/toyamarinyon/giselle/blob/main/.claude/workspace-config/claude/commands/create-pr.md) &nbsp; by &nbsp; [toyamarinyon](https://github.com/toyamarinyon)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;Apache-2.0  
...
[`/create-pull-request`](https://github.com/liam-hq/liam/blob/main/.claude/workspace-config/claude/commands/create-pull-request.md) &nbsp; by &nbsp; [liam-hq](https://github.com/liam-hq)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;Apache-2.0  
...
[`/create-worktrees`](https://github.com/evmts/tevm-monorepo/blob/main/.claude/workspace-config/claude/commands/create-worktrees.md) &nbsp; by &nbsp; [evmts](https://github.com/evmts)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/fix-github-issue`](https://github.com/jeremymailen/kotlinter-gradle/blob/master/.claude/workspace-config/claude/commands/fix-github-issue.md) &nbsp; by &nbsp; [jeremymailen](https://github.com/jeremymailen)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;Apache-2.0  
...
[`/fix-issue`](https://github.com/metabase/metabase/blob/master/.claude/workspace-config/claude/commands/fix-issue.md) &nbsp; by &nbsp; [metabase](https://github.com/metabase)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;NOASSERTION  
...
[`/fix-pr`](https://github.com/metabase/metabase/blob/master/.claude/workspace-config/claude/commands/fix-pr.md) &nbsp; by &nbsp; [metabase](https://github.com/metabase)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;NOASSERTION  
...
[`/husky`](https://github.com/evmts/tevm-monorepo/blob/main/.claude/workspace-config/claude/commands/husky.md) &nbsp; by &nbsp; [evmts](https://github.com/evmts)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/update-branch-name`](https://github.com/giselles-ai/giselle/blob/main/.claude/workspace-config/claude/commands/update-branch-name.md) &nbsp; by &nbsp; [giselles-ai](https://github.com/giselles-ai)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;Apache-2.0  
...
[`/check`](https://github.com/rygwdn/slack-tools/blob/main/.claude/workspace-config/claude/commands/check.md) &nbsp; by &nbsp; [rygwdn](https://github.com/rygwdn)    
...
[`/code_analysis`](https://github.com/kingler/n8n_agent/blob/main/.claude/workspace-config/claude/commands/code_analysis.md) &nbsp; by &nbsp; [kingler](https://github.com/kingler)    
...
[`/optimize`](https://github.com/to4iki/ai-project-rules/blob/main/.claude/workspace-config/claude/commands/optimize.md) &nbsp; by &nbsp; [to4iki](https://github.com/to4iki)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/repro-issue`](https://github.com/rzykov/metabase/blob/master/.claude/workspace-config/claude/commands/repro-issue.md) &nbsp; by &nbsp; [rzykov](https://github.com/rzykov)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;NOASSERTION  
...
[`/tdd`](https://github.com/zscott/pane/blob/main/.claude/workspace-config/claude/commands/tdd.md) &nbsp; by &nbsp; [zscott](https://github.com/zscott)    
...
[`/tdd-implement`](https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/tdd-implement.md) &nbsp; by &nbsp; [jerseycheese](https://github.com/jerseycheese)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/context-prime`](https://github.com/elizaOS/elizaos.github.io/blob/main/.claude/workspace-config/claude/commands/context-prime.md) &nbsp; by &nbsp; [elizaOS](https://github.com/elizaOS)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/initref`](https://github.com/okuvshynov/cubestat/blob/main/.claude/workspace-config/claude/commands/initref.md) &nbsp; by &nbsp; [okuvshynov](https://github.com/okuvshynov)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/load-llms-txt`](https://github.com/ethpandaops/xatu-data/blob/master/.claude/workspace-config/claude/commands/load-llms-txt.md) &nbsp; by &nbsp; [ethpandaops](https://github.com/ethpandaops)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/load_coo_context`](https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/load_coo_context.md) &nbsp; by &nbsp; [Mjvolk3](https://github.com/Mjvolk3)    
...
[`/load_dango_pipeline`](https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/load_dango_pipeline.md) &nbsp; by &nbsp; [Mjvolk3](https://github.com/Mjvolk3)    
...
[`/prime`](https://github.com/yzyydev/AI-Engineering-Structure/blob/main/.claude/workspace-config/claude/commands/prime.md) &nbsp; by &nbsp; [yzyydev](https://github.com/yzyydev)    
...
[`/rsi`](https://github.com/ddisisto/si/blob/main/.claude/workspace-config/claude/commands/rsi.md) &nbsp; by &nbsp; [ddisisto](https://github.com/ddisisto)    
...
[`/add-to-changelog`](https://github.com/berrydev-ai/blockdoc-python/blob/main/.claude/workspace-config/claude/commands/add-to-changelog.md) &nbsp; by &nbsp; [berrydev-ai](https://github.com/berrydev-ai)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/create-docs`](https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/create-docs.md) &nbsp; by &nbsp; [jerseycheese](https://github.com/jerseycheese)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/docs`](https://github.com/slunsford/coffee-analytics/blob/main/.claude/workspace-config/claude/commands/docs.md) &nbsp; by &nbsp; [slunsford](https://github.com/slunsford)    
...
[`/explain-issue-fix`](https://github.com/hackdays-io/toban-contribution-viewer/blob/main/.claude/workspace-config/claude/commands/explain-issue-fix.md) &nbsp; by &nbsp; [hackdays-io](https://github.com/hackdays-io)    
...
[`/update-docs`](https://github.com/Consiliency/Flutter-Structurizr/blob/main/.claude/workspace-config/claude/commands/update-docs.md) &nbsp; by &nbsp; [Consiliency](https://github.com/Consiliency)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/release`](https://github.com/kelp/webdown/blob/main/.claude/workspace-config/claude/commands/release.md) &nbsp; by &nbsp; [kelp](https://github.com/kelp)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/run-ci`](https://github.com/hackdays-io/toban-contribution-viewer/blob/main/.claude/workspace-config/claude/commands/run-ci.md) &nbsp; by &nbsp; [hackdays-io](https://github.com/hackdays-io)    
...
[`/create-command`](https://github.com/scopecraft/command/blob/main/.claude/workspace-config/claude/commands/create-command.md) &nbsp; by &nbsp; [scopecraft](https://github.com/scopecraft)    
...
[`/create-plan`](https://github.com/hesreallyhim/inkverse-fork/blob/preserve-claude-resources/.claude/workspace-config/claude/commands/create-plan.md) &nbsp; by &nbsp; [taddyorg](https://github.com/taddyorg)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;AGPL-3.0  
...
[`/create-prp`](https://github.com/Wirasm/claudecode-utils/blob/main/.claude/workspace-config/claude/commands/create-prp.md) &nbsp; by &nbsp; [Wirasm](https://github.com/Wirasm)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/do-issue`](https://github.com/jerseycheese/Narraitor/blob/feature/issue-227-ai-suggestions/.claude/workspace-config/claude/commands/do-issue.md) &nbsp; by &nbsp; [jerseycheese](https://github.com/jerseycheese)  &nbsp;&nbsp;⚖️&nbsp;&nbsp;MIT  
...
[`/project_hello_w_name`](https://github.com/disler/just-prompt/blob/main/.claude/workspace-config/claude/commands/project_hello_w_name.md) &nbsp; by &nbsp; [disler](https://github.com/disler)    
...
[`/fixing_go_in_graph`](https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/fixing_go_in_graph.md) &nbsp; by &nbsp; [Mjvolk3](https://github.com/Mjvolk3)    
...
[`/review_dcell_model`](https://github.com/Mjvolk3/torchcell/blob/main/.claude/workspace-config/claude/commands/review_dcell_model.md) &nbsp; by &nbsp; [Mjvolk3](https://github.com/Mjvolk3)    
...
[`/use-stepper`](https://github.com/zuplo/docs/blob/main/.claude/workspace-config/claude/commands/use-stepper.md) &nbsp; by &nbsp; [zuplo](https://github.com/zuplo)    
