...
- Skill discovery supports both `.claude/workspace-config/claude/skills/` and `.agents/skills/` paths
...
### Removed
- Domain expertise feature (`~/.claude/workspace-config/claude/skills/expertise/`) - was personal tooling not available to other users
