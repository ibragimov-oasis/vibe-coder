...
Place custom agent definitions in `~/.claude/workspace-config/claude/agents/{agent-name}.md` and they'll override the defaults.

For example, if you want a specialized Python testing agent:
```markdown
# ~/.claude/workspace-config/claude/agents/pytest-specialist.md
