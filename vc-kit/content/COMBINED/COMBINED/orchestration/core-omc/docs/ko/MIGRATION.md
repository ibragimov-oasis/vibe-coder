...
- **이전**: `~/.claude/workspace-config/claude/skills/sisyphus-learned/`
- **이후**: `~/.claude/workspace-config/claude/skills/omc-learned/`
...
# 스킬 디렉토리
mv ~/.claude/workspace-config/claude/skills/sisyphus-learned ~/.claude/workspace-config/claude/skills/omc-learned
...
- **사용자 레벨**: `~/.claude/workspace-config/claude/skills/omc-learned/` (이식 가능)
