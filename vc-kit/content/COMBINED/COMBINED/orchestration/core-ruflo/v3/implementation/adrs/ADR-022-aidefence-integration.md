...
```yaml
# v3/@claude-flow/cli/.claude/workspace-config/claude/skills/aidefence.yaml
...
```yaml
# v3/@claude-flow/cli/.claude/workspace-config/claude/agents/v3/security-architect.yaml (enhancement)
