...
| `guidance_discover` | Live filesystem scan of `.claude/workspace-config/claude/agents/` and `.claude/workspace-config/claude/skills/` |
...
- `.claude/workspace-config/claude/agents/**/*.md` — 100+ files standardized
- `.claude/workspace-config/claude/skills/**/SKILL.md` — 17 files standardized
