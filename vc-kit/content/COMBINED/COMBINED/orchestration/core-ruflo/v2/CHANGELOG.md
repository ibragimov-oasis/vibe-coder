...
- ✅ All 6 AgentDB skills included in `.claude/workspace-config/claude/skills/` directory
...
- **Fixed**: Skills copier path resolution in both `bin/init/skills-copier.js` and `src/cli/simple-commands/init/skills-copier.js`
  ...
  - Resolves issue where `.claude/workspace-config/claude/skills/` directory remained empty after init
...
- **New**: `.claude/workspace-config/claude/skills/` directory structure for project skills
- **New**: `bin/init/skills-copier.js` - Automated skills installation

#### **Init System Enhancements**
- **Skills Integration**: `npx claude-flow init` now copies 21 built-in skills to `.claude/workspace-config/claude/skills/`
...
- **Removed**: 68 command files from `.claude/workspace-config/claude/commands/` (migrated to skills)
...
- **Migration Path**: All functionality preserved in skills system
  - Old: `.claude/workspace-config/claude/commands/swarm/research.md`
  - New: `swarm-orchestration` skill (auto-discovered)

### 📚 Documentation Updates

- **Updated**: `.gitignore` to exclude `.claude/workspace-config/claude/skills/` from version control
...
```
1. Personal Skills (~/.claude/workspace-config/claude/skills/) - User custom skills
2. Project Skills (.claude/workspace-config/claude/skills/) - Team shared skills
...
6. `.gitignore` - Added `.claude/workspace-config/claude/skills/` exclusion
...
- `.claude/workspace-config/claude/skills/` directory structure
- `bin/init/skills-copier.js`
- `.claude/settings.reasoningbank-example.json`
- `.claude/settings.reasoningbank-minimal.json`

**Removed Files:**
- 68 command files from `.claude/workspace-config/claude/commands/` (migrated to skills)
...
2. Run init: `npx claude-flow init` (copies skills to `.claude/workspace-config/claude/skills/`)
...
**Deprecations:**
- `.claude/workspace-config/claude/commands/` - Use skills system instead
...
- **Sublinear-time-solver Integration**: Removed sublinear-time-solver MCP server from initialization
  - Deleted `.claude/workspace-config/claude/agents/sublinear/` folder creation during init
...
### 🔧 Technical Details
- Both commands now create only the agent markdown file in `.claude/workspace-config/claude/agents/[module]/`
...
- **Fixed Init Command**: Now creates ALL 91 command documentation files
  - 10 swarm command files in `.claude/workspace-config/claude/commands/swarm/`
  - 12 hive-mind command files in `.claude/workspace-config/claude/commands/hive-mind/`
  - 5 agents documentation files in `.claude/workspace-config/claude/commands/agents/`
...
- **Complete Documentation Structure**: Created comprehensive docs in `.claude/workspace-config/claude/commands/`
...
#### New Documentation
- **Command Documentation System**: Complete docs in `.claude/workspace-config/claude/commands/`
...
- `.claude/workspace-config/claude/commands/stream-chain/README.md` - Stream chain main documentation
- `.claude/workspace-config/claude/commands/stream-chain/pipeline.md` - Pipeline documentation
- `.claude/workspace-config/claude/commands/stream-chain/run.md` - Run command documentation
- `.claude/workspace-config/claude/commands/pair/README.md` - Pair programming overview
- `.claude/workspace-config/claude/commands/pair/start.md` - Starting sessions guide
- `.claude/workspace-config/claude/commands/pair/modes.md` - Collaboration modes guide
- `.claude/workspace-config/claude/commands/pair/session.md` - Session management guide
- `.claude/workspace-config/claude/commands/pair/config.md` - Configuration reference
- `.claude/workspace-config/claude/commands/pair/commands.md` - Command reference
- `.claude/workspace-config/claude/commands/pair/examples.md` - Real-world examples
- `.claude/workspace-config/claude/commands/verify/README.md` - Verification documentation
- `.claude/workspace-config/claude/commands/truth/README.md` - Truth metrics documentation
...
### 🚀 Features
- **Agent System Fix**: Dynamic loading from .claude/workspace-config/claude/agents/ (#485)
...
### 🛠️ Improvements
- Updated all 18 SPARC command files in .claude/workspace-config/claude/commands/sparc/ with MCP/NPX fallback
...
- **6 specialized command modes** in `.claude/workspace-config/claude/commands/github/`:
...
#### **Configuration**
- **New `.claude/workspace-config/claude/commands/github/` directory** structure for GitHub workflow commands
...
- **New GitHub commands** available in `.claude/workspace-config/claude/commands/github/`
...
#### Configuration
- **New configuration files** in `.claude/workspace-config/claude/commands/github/`
