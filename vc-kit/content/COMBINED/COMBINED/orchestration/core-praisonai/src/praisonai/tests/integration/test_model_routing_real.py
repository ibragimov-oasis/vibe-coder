...
class TestRouterHandlerReal:
    ...
    def test_model_selection_by_complexity(self):
        ...
        assert simple_model in ['gpt-4o-nano', 'gpt-4o-mini', 'claude-3-haiku', 'gemini-1.5-flash']
        ...
        assert complex_model in ['gpt-4o-nano', 'gpt-4-turbo', 'claude-3-opus', 'o1-preview']
    ...
    def test_merge_with_defaults(self):
        ...
        assert 'gpt-4o-mini' in available or 'gpt-4o-nano' in available
