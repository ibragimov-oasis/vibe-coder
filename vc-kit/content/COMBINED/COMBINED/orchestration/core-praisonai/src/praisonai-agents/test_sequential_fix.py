...
def test_agent_direct():
    """Test using gpt-4o-nano directly (agent.py path)"""
    print("=" * 50)
    print("Testing gpt-4o-nano (agent.py path)")
    print("=" * 50)
...
def test_llm_class():
    """Test using openai/gpt-4o-nano (llm.py path)"""
    print("\n" + "=" * 50)
    print("Testing openai/gpt-4o-nano (llm.py path)")
    print("=" * 50)
...
if __name__ == "__main__":
    try:
        ...
        print("✅ gpt-4o-nano uses agent.py direct OpenAI calls")
        print("✅ openai/gpt-4o-nano uses llm.py LiteLLM wrapper")
