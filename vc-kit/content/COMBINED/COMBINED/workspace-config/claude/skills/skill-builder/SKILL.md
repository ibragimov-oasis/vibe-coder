...
mkdir -p ~/.claude/workspace-config/claude/skills/my-first-skill

# 2. Create SKILL.md with proper format
cat > ~/.claude/workspace-config/claude/skills/my-first-skill/SKILL.md << 'EOF'
---
name: "My First Skill"
...
```
~/.claude/workspace-config/claude/skills/                    # Personal skills location
└── my-skill/                        # Skill directory (MUST be at top level!)
    └── SKILL.md                     # REQUIRED: Main skill file
```

**IMPORTANT**: Skills MUST be directly under `~/.claude/workspace-config/claude/skills/[skill-name]/`.
...
└── [your-skills]/
```
- **Path**: `~/.claude/workspace-config/claude/skills/` or `$HOME/.claude/workspace-config/claude/skills/`
...
```
<project-root>/.claude/workspace-config/claude/skills/
└── [team-skills]/
```
- **Path**: `.claude/workspace-config/claude/skills/` in project root
...
- [ ] Directory is DIRECTLY in `~/.claude/workspace-config/claude/skills/[skill-name]/` or `.claude/workspace-config/claude/skills/[skill-name]/`
