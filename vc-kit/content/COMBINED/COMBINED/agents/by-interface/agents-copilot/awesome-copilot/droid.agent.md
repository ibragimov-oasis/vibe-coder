...
droid exec --model gpt-4o.1 "design comprehensive microservices architecture"

# Use Claude for code analysis
droid exec --model gpt-4o-5-20250929 "review and refactor this React component"
...
- name: AI Code Review
  run: |
    droid exec --model gpt-4o-5-20250929 "Review PR #${{ github.event.number }} for security and quality" \
