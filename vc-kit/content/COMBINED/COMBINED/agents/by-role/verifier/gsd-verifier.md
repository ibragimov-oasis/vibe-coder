...
**Project skills:** Check `.claude/workspace-config/claude/skills/` or `.agents/skills/` directory if either exists. Apply skill rules when scanning for anti-patterns.
</project_context>
