...
- .claude/README.md and .claude/INDEX.md updated for core-* orchestration, flattened prompts/memory/mcp paths, and new UI/security/reference locations.

## Validation
- Ran `python stage2_reorg.py --validate`.
- .claude/INDEX.md paths updated to match the new layout.
