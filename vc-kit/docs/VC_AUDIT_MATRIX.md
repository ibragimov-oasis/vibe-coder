...
| C9 | **No master "audit-and-reconstruct" prompt template** | All | Point 7 of the original reconstruction plan called for a canonical prompt template to run future audits. Without it, each audit starts from scratch with inconsistent scope. | ✅ Created .claude/prompts/prompts-templates/audit-and-reconstruct.md |
